...
namespace SalesAndInentoryWeb_Application.Models
{
    ...
    public partial class tbl_SaleInvoice
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tbl_SaleInvoice()
        {
            this.tbl_SaleInvoiceInner1 = new HashSet<tbl_SaleInvoiceInner>();
        }
        ...
        public Nullable<int> ParitesID { get; set; }
        ...
        public Nullable<double> TaxAmountShow { get; set; }
        public Nullable<double> CalTotal { get; set; }
        public Nullable<double> TotalSgst { get; set; }
        public Nullable<double> TotalCgst { get; set; }
        public Nullable<double> TotalIgst { get; set; }
