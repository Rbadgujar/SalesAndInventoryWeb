...
namespace SalesAndInentoryWeb_Application.Controllers
{
    public class CompanyController : Controller
    {
        ...
        public ActionResult com(int id = 0)
        {
            ...
            {
                var tb = db.tbl_CompanyMasterSelect("Details", id, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,null,null).Single(x => x.CompanyID == id);
        ...
        public ActionResult com(IEnumerable<HttpPostedFileBase> files, tbl_CompanyMasterSelectResult com, int id = 0)
        {
            try
            {
                ...
                {
                    db.tbl_CompanyMasterSelect("Update", id, com.CompanyName, com.ContactNo, com.EmailID, com.ReferaleCode, com.BusinessType, com.Address, com.City, com.State, com.GSTNumber, com.OwnerName, com.Signature, com.AddLogo, com.BankName, com.AccountNo, com.IFSC_Code, com.CompanyID,null,null);
                    db.SubmitChanges();
                    return RedirectToAction("Index");
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                var getdata = db.tbl_CompanyMasterSelect("Delete", id, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,null,null).ToList();
                db.SubmitChanges();
        ...
        public ActionResult Company(HttpPostedFileBase file, tbl_CompanyMasterSelectResult com)
        {
            ...
            { 
                ...
                db.tbl_CompanyMasterSelect("Insert",null,filepath,com.ContactNo, com.EmailID, com.ReferaleCode, com.BusinessType, com.Address, com.City, com.State, com.GSTNumber, com.OwnerName, com.Signature, com.AddLogo, com.BankName, com.AccountNo, com.IFSC_Code,com.CompanyID,null,null);             
                db.SubmitChanges();
                return RedirectToAction("Index");
            }
            catch(Exception)
