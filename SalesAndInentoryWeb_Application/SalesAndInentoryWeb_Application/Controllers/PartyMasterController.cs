...
namespace SalesAndInentoryWeb_Application.Controllers
{
    public class PartyMasterController : Controller
    {
        ...
        public ActionResult AddOrEdit(tbl_PartyMaster party)//int id = 0)
        {
            ...
            using (idealtec_inventoryEntities10 entities = new idealtec_inventoryEntities10())
            {
                tbl_PartyMaster party1 = entities.PartyMasterCrud("Insert", null, party.PartyName, party.ContactNo, party.BillingAddress, party.EmailID, party.GSTType, party.State, party.OpeningBal, party.AsOfDate, party.AddRemainder,  party.PartyType, party.ShippingAddress,  party.PartyGroup,null,party.PaidStatus, null ).FirstOrDefault();
                return View(party1);
            }
